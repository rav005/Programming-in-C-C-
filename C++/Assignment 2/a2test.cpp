...
int EANTests(const Prefix& list, int& testNo, int* passed, int* tested) {
    ...
    if(ean.empty() != 0) {
        testFailed("empty() did not return false for 9070002046", ++testNo,
         &ok, tested);
    } else
    ...
    if(ean.isRegistered() == 0) {
        testFailed("isRegistered() did not return true for 9070002046",
         ++testNo, &ok, tested);
    } else
    ...
    if(ean.empty() == 0) {
        testFailed("empty() did not return true for 9070002043", ++testNo,
         &ok, tested);
    } else
    ...
    if(ean.isRegistered() != 0) {
        testFailed("isRegistered() did not return false for 9070002043",
         ++testNo, &ok, tested);
    } else
...
int RegisteredTests(const Prefix& list, int& testNo, int* passed, int* tested) {
    ...
    if(ean.isRegistered()) {
        ...
        testPassed("isRegistered() returned true for 9789995500009", ++testNo,
         passed, tested);
